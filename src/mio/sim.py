...
def create_sim_directories():
    ...
    common.create_dir(cfg.sim_output_dir + "/viv/cmp_external"        )
    common.create_dir(cfg.sim_output_dir + "/viv/cmp_local"           )
    ...
    common.create_dir(cfg.sim_output_dir + "/mtr/cmp_external"        )
    common.create_dir(cfg.sim_output_dir + "/mtr/cmp_local"           )
    ...
    common.create_dir(cfg.sim_output_dir + "/vcs/cmp_external"        )
    ...
    common.create_dir(cfg.sim_output_dir + "/xcl/cmp_external"        )
    ...
    common.create_dir(cfg.sim_output_dir + "/qst/cmp_external"        )
    common.create_dir(cfg.sim_output_dir + "/qst/cmp_local"           )
    ...
    common.create_dir(cfg.sim_output_dir + "/riv/cmp_external"        )
    common.create_dir(cfg.sim_output_dir + "/riv/cmp_local"           )
